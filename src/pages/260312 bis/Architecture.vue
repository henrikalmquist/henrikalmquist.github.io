...
<div class="service-header">
  <img src="/img/service_01.jpg" class="service-icon">

  <div class="service-text">
    <strong>Consultancy</strong><br>
    AAA offers support in navigating, identifying values and finding ways forward through an adaptive approach in early-stage developments for existing buildings and places.
  </div>
</div>
...
<div class="service-header">
  <img src="/img/service_02.jpg" class="service-icon">
...
<div class="service-header">
  <img src="/img/service_03.jpg" class="service-icon">

  <div class="service-text">
    <strong>Project</strong><br>
    AAA has extensive experience in leading architecture projects for renovations or additions, aiming to achieve the greatest effect with the means available. 
  </div>
</div>
</div>
`
